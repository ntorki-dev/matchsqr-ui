...
function renderCard() {
  ...
  const body =
    '<div>' +
      ...
      (haveSession ? '' : '<p class="help" style="font-size: 50%;margin:10px 0 0 0"><br> </br>You can register within 30 minutes to receive your full report, or your answers will be deleted.</p>') +
    '</div>';
